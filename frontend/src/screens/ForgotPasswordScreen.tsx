      ...
      <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={["top"]}>
        <View style={[styles.flex, contentWrap]}>
          <View style={styles.cardWrapper}>
            ...
            >
              <Text style={[styles.title, { color: colors.text }]}>{t("auth.checkEmail")}</Text>
              <Text style={[styles.hint, { color: colors.textMuted }]}>{t("auth.checkEmailHint")}</Text>
              <TouchableOpacity
                ...
                onPress={onGoToLogin}
              >
                <Text style={[styles.buttonPrimaryText, { color: colors.primaryText }]}>{t("auth.backToLogin")}</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
              ...
              >
                ...
                >
                  {loading ? (
                    ...
                    <Text style={[styles.buttonPrimaryText, { color: colors.primaryText }]}>{t("auth.sendResetLink")}</Text>
                  )}
                </TouchableOpacity>
                <TouchableOpacity
                  accessibilityRole="button"
