...
import { getAuthIntervalsAuthorizeUrl, register, type AuthUser } from "../api/client";
...
export function RegisterScreen({
  ...
  const handleIntervalsRegister = async () => {
            ...
            >
              {intervalsLoading ? (
                ...
                <>
                  ...
                  <Text style={[styles.buttonSecondaryText, { color: colors.text }]}>{t("auth.registerWithIntervals")}</Text>
                </>
              )}
            </TouchableOpacity>
            <TouchableOpacity
