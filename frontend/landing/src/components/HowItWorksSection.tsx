...
const steps = [
  { icon: Link2, titleKey: "howItWorks.step1Title", descKey: "howItWorks.step1Desc", actionKey: "howItWorks.step1Action", isResult: false },
  { icon: Camera, titleKey: "howItWorks.step2Title", descKey: "howItWorks.step2Desc", actionKey: "howItWorks.step2Action", isResult: false },
  { icon: Brain, titleKey: "howItWorks.step3Title", descKey: "howItWorks.step3Desc", actionKey: "howItWorks.step3Action", isResult: true },
];

const labelKeys = ["howItWorks.labelInput", "howItWorks.labelAnalysis", "howItWorks.labelRecommendation"] as const;
  ...
  return (
    <section id="how-it-works" className="py-20 px-6 bg-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-center">{t("howItWorks.title")}</h2>
        ...
        <div className="relative grid md:grid-cols-3 gap-8 items-start">
          ...
          {steps.map((s, i) => (
            <div key={s.titleKey} className="relative z-10 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold mb-3">{t(s.titleKey)}</h3>
              <p className="text-white/60 text-sm mb-6 max-w-xs mx-auto">{t(s.descKey)}</p>
              ...
              <div className={`w-full max-w-[280px] rounded-lg p-4 text-left border ${
                ...
                <div className={`font-mono text-sm ${s.isResult ? "text-emerald-400 font-bold" : "text-white/80"}`}>
                  {s.isResult ? (
                    <>
                      <span className="text-yellow-400">{t("howItWorks.exampleModify")}</span><br/>
